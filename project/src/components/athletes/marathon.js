  ...
  >
    <Container maxW="xl" bg="white" p={8} borderRadius="lg" boxShadow="md">
      <VStack spacing={6} align="start">
        <Heading as="h1" size="xl" color="black">Marathon Meal Plan</Heading>
        ...
        <Text mt={4}>
        A marathon is a long-distance running race with a standard distance of 42.195 kilometers (26.2 miles). It is a test of endurance and stamina, typically held on roads or trails. The marathon can be run as a competitive event or as part of a personal fitness challenge.
        ...
        Day 1
•⁠  ⁠Breakfast: Whole grain oatmeal with banana slices, chia seeds, and a drizzle of honey.
...
•⁠  ⁠Evening Snack: Cottage cheese with fresh berries.<br/><br/>
Day 2
...
•⁠  ⁠Evening Snack: Cottage cheese with pineapple chunks.<br/><br/>
Day 6
