...
// import { Box, Image, Text, Button, Heading, Stack } from '@chakra-ui/react';
...
//         <Image 
//          // src={https://source.unsplash.com/featured/?${ingredient}} 
//           alt={ingredient} 
//           boxSize="200px" 
//           objectFit="cover" 
//         />
//         <Text fontSize="xl">{ingredient}</Text>
//         <Text fontSize="md">Price: $5</Text>
//         <Button onClick={addToCart} colorScheme="teal">
//           Add to Cart
//         </Button>
//       </Stack>
//       <Stack spacing={4} align="center">
...
const ProductPage = () => {
  ...
  const BuyNow = (productName) => {
    console.log(`${productName} BuyNow`);
    navigate('/checkout');
  };
